...
def ensure_directory_exists(path):
    os.makedirs(path, exist_ok=True)  # This will create the directory if it doesn't exist, and do nothing if it does
...
def sample_pca_t5_full_center():
    ...
    # results_file_path = "./result/t5_sentinel/pca_sampling_result_edges.txt"
    # ensure_directory_exists(results_file_path)
...
def sample_pca_t5_full_edge():
    ...
    results_file_path = "./result/t5_sentinel/pca_sampling_result_edges.txt"
    ensure_directory_exists(Path(results_file_path).parent)  # Ensure directory exists
